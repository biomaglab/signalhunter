...
[output_file, output_path] = uiputfile({'*.xls;*.xlsx','MS Excel Files (*.xls,*.xlsx)'},...
    'Export data', filename);
file_output = [output_path output_file];

if strcmp(process_id(1:5),'Serie') == 1
...
elseif strcmp(process_id(1:6),'MVCpre') == 1
...
elseif strcmp(process_id(1:7),'MVC2min') == 1
